...
if(!check_log('pca2')){
print('Projected PCA')
seur = project.pca(seur, do.print=T, pcs.store=75)
genes.use = pca.sig.genes(seur, 1:log$pc_sig, pval.cut=1e-3, max.per.pc=250)
seur = pca(seur, pc.genes=genes.use, do.print=T, pcs.store=75)
